...
describe('User Service', () => {
    ...
    describe('updateProfile', () => {
        it('should update user and return sanitized user', async () => {
            ...
            const result = await userService.updateProfile('user-uuid', data);
            ...
            expect(result).toHaveProperty('profilePictureUrl', null); // avatarUrl mapped
        });
    ...
    describe('getPrivacy', () => {
        it('should return privacy settings', async () => {
            const mockUser = { privacySettings: { profileVisibility: 'private' } };
            (prisma.user.findUnique as jest.Mock).mockResolvedValue(mockUser);
