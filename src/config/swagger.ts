...
const options: swaggerJsdoc.Options = {
    definition: {
        ...
        paths: {
            ...
            // ============ NEW ENHANCED CONTENT ENDPOINTS ============
            // Recharge
            '/lessons/{id}/recharge-status': {
                get: {
                    tags: ['Lessons'],
                    summary: 'Get recharge status for current user',
                    security: [{ bearerAuth: [] }],
                    parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }],
                    responses: { '200': { description: 'Recharge status' } },
                },
            },
            // Slides
                        ...
                        content: {
                            'application/json': {
                                schema: {
                                    ...
                                    properties: {
                                        orderedSlideIds: { type: 'array', items: { type: 'string' } },
                                    },
                                },
                            },
                        },
            ...
            '/lessons/{lessonId}/slides/{slideId}/complete': {
                post: {
                    ...
                    responses: { '200': { description: 'Slide completed' } },
                },
            },
            // Quest Checkpoints
                        ...
                        content: {
                            'application/json': {
                                schema: {
                                    ...
                                    properties: {
                                        orderedCheckpointIds: { type: 'array', items: { type: 'string' } },
                                    },
                                },
                            },
                        },
                        ...
                        content: {
                            'application/json': {
                                schema: {
                                    ...
                                    properties: {
                                        completed: { type: 'boolean' },
                                        selfReflectionAnswer: { type: 'string' },
                                    },
                                },
                            },
                        },
                    },
                    responses: { '200': { description: 'Checkpoint completed' } },
                },
            },
            // Boss Battle
            '/modules/{moduleId}/boss-battle': {
                            ...
                            'application/json': {
                                schema: {
                                    ...
                                    properties: {
                                        ...
                                        victoryBonusPerfect: { type: 'integer' },
                                        victoryBonusGood: { type: 'integer' },
                                        victoryBonusFair: { type: 'integer' },
                                        victoryBonusRetry: { type: 'integer' },
                                        questions: {
                                            type: 'array',
                                            items: {
                                                type: 'object',
                ...
                get: {
                    ...
                    security: [{ bearerAuth: [] }],
                    parameters: [{ name: 'moduleId', in: 'path', required: true, schema: { type: 'string' } }],
                    responses: { '200': { description: 'Boss battle details' } },
                },
            },
            ...
            '/modules/{moduleId}/boss-battle/submit': {
                post: {
                    ...
                    responses: { '200': { description: 'Boss battle submitted' } },
                },
            },
        },
    },
